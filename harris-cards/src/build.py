...
VID  = '6kPHnl-RsVI'
NICK = 'Harris'
TITLE_KO = 'AI 는 우리의 시험이자 초대장'
TITLE_EN = 'Why AI Is Our Ultimate Test and Greatest Invitation'
SPEAKER  = ('Harris', 'Tristan Harris', '트리스탄 해리스', 1)

# 장면 = 강연의 논지 전환 (키, 시작초, 한국어, 영어)
SCENES = [
 ('open',   0,   '도입 · 기술자로 살아온 나',   'Opening: life as a technologist'),
 ('diff',   120, 'AI 는 왜 다른가',           'Why AI is different'),
 ('rip',    235, '「그냥 풀어놓자」 대 규제',    '"Let it rip" vs. regulation'),
 ('race',   420, '출시 경쟁과 유인 구조',       'The race to roll out'),
 ('trap',   640, '불가피론의 함정',            'The trap of inevitability'),
 ('choice', 760, '우리가 선택할 수 있는 것',    'The choice we still have'),
]
