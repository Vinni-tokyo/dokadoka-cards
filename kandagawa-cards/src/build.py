...
OUT = os.path.join(os.path.dirname(S), 'Japanese-Kandagawa22-Cards.html')
VID = 'JSgyHiKESGw'

# 구간(빈 줄로 나뉜 덩어리) 순서대로. (키, 한국어, 일본어)
SECTIONS = [
 ('v1',   '1절 · 요코초의 목욕탕',   '1番 · 横丁の風呂屋'),
 ('cho1', '후렴 1 · 어렸던 그때',    'サビ 1 · 若かったあの頃'),
 ('v2',   '2절 · 스물네 색 크레파스', '2番 · 二十四色のクレパス'),
 ('cho2', '후렴 2',                 'サビ 2'),
]
SPEAKERS = [('Singer', 'かぐや姫', '카구야히메', 1), ('', '不明', '화자 미상', 0)]
