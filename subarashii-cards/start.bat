...
if not exist "%~dp0Japanese-Subarashii32-Cards.html" goto :nofile
set PORT=8117
set PAGE=Japanese-Subarashii32-Cards.html
...
:nofile
echo [!] Japanese-Subarashii32-Cards.html 을 찾을 수 없습니다.
