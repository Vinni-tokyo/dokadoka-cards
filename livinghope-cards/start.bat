...
if not exist "%~dp0Japanese-LivingHope39-Cards.html" goto :nofile
set PORT=8121
set PAGE=Japanese-LivingHope39-Cards.html
...
:nofile
echo [!] Japanese-LivingHope39-Cards.html 을 찾을 수 없습니다.
