...
**듣기 모드(걸으면서)** · 홈의 「듣기 모드」. 덱·장·모드(단어 듣기 / 거꾸로 듣기 / 한자 듣기)·침묵 길이·바퀴 수·자동 종료·음성 엔진(온라인/기기)을 고르고 시작하면
「읽기 → 침묵(떠올리기) → 뜻 → 읽기 → 대사」 순으로 재생합니다. 재생은 **오디오 요소 하나**에 클립을 「다음 곡」으로 이어 넣는 방식이라(음악 앱과 같음)
화면을 꺼도 잠금 화면 미디어 컨트롤(재생/일시정지/다음/이전)이 뜨고 계속 납니다. 침묵 구간은 들리지 않는 20Hz 저음으로 채워 브라우저가 「소리 없음」으로
판정하지 않게 합니다. 「이전」 두 번 또는 「모르겠다」는 그 카드를 복습함에 넣고, 들은 카드는 홈의 「오늘 들은 것 다시 보기」에 모입니다.
재생 화면의 「진단」에 클립별 재생 기록이 남습니다.
