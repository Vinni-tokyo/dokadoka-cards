...
**대사 재생** · 한자어 카드의 예문은 영상 앱의 실제 대사입니다. 뜻을 연 뒤 예문 상자의 「▶ 대사 재생」을 누르면 그 대사가 나온 영상의 그 구간만 카드 위에서 바로 틉니다. 「🔁 반복」을 켜면 구간을 되풀이합니다(따라 말하기용). 폰에서는 **「🔊 소리만」이 기본**이라 영상 대신 한 줄짜리 상태 줄만 뜨고 소리만 납니다(끄면 영상이 보입니다. 설정은 저장). 숨긴 재생을 막는 브라우저면 3초 뒤 영상 모드로 물러납니다. 「장면 ›」은 그 대사가 나온 앱을 엽니다. 유튜브는 처음 누를 때 받습니다.

**듣기 모드** · 홈의 「듣기 모드」. 덱·장·모드(단어 듣기 / 거꾸로 듣기 / 한자 듣기)·예문 읽기 여부·침묵 길이·**어디까지(전체 장 / 이 장만)**·**예문을 원본 대사로(1번/2번)**·바퀴 수·자동 종료·음성 엔진(온라인/기기)을 고르고 시작하면
