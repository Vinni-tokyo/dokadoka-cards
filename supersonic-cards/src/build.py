...
SCENES = [
 ('intro',  0,      'イントロ',      '인트로'),
 ('v1',     12.78,  '1番 Aメロ',     '1절'),
 ('pre1',   35.31,  '1番 Bメロ',     '1절 프리코러스'),
 ('cho1',   50.45,  '1番 サビ',      '1절 후렴'),
 ('v2',     68.00,  '2番 Aメロ',     '2절'),
 ('pre2',   90.19,  '2番 Bメロ',     '2절 프리코러스'),
 ('cho2',   105.27, '2番 サビ',      '2절 후렴'),
 ('bridge', 123.34, 'ブリッジ',      '브릿지'),
 ('cho3',   139.71, 'ラストサビ',    '마지막 후렴'),
]
...
series = {
 'id': 'supersonic', 'videoId': VID, 'seal': '歌',
 'title': 'Supersonic', 'titleKo': 'fromis_9 (프로미스나인) — Supersonic (노포라이브)',
 'subtitle': 'fromis_9 · ライブ映像(歌のみ) · 歌詞は公式MVの字幕', 'subtitleKo': '프로미스나인 · 라이브 영상(노래만) · 가사는 공식 MV 자막',
