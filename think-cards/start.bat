@echo off
rem === 도카도카 영어 공부 · AI 와 비판적 사고 / Dokadoka English — 로컬 서버로 열기 ===
rem YouTube 는 file:// 재생을 거부하므로(Error 153) 간이 서버를 띄워 http:// 로 연다.
setlocal enabledelayedexpansion
cd /d "%~dp0"
if /i "%CD:~0,2%"=="\\" goto :unc
if not exist "%~dp0English-Thinking127-Cards.html" goto :nofile
set PORT=8088
set PAGE=English-Thinking127-Cards.html
...
:nofile
echo [!] English-Thinking127-Cards.html 을 찾을 수 없습니다.
