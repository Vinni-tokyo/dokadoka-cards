@echo off
rem === First Love 하츠코이 메이킹 학습 카드 — 로컬 서버로 열기 ===
setlocal enabledelayedexpansion
cd /d "%~dp0"
if /i "%CD:~0,2%"=="\\" goto :unc
if not exist "%~dp0Japanese-Hatsukoi172-Cards.html" goto :nofile
set PORT=8086
set PAGE=Japanese-Hatsukoi172-Cards.html
...
:nofile
echo [!] Japanese-Hatsukoi172-Cards.html 을 찾을 수 없습니다.
