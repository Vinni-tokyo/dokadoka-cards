...
OUT = os.path.join(os.path.dirname(S), 'Japanese-Mahou30-Cards.html')
VID = 'R7wI90H6Wuc'

# 구간(빈 줄로 나뉜 덩어리) 순서대로. (키, 한국어, 일본어)
SECTIONS = [
 ('v1',   '1절 · 사소한 일로',   '1番 · くだらないことで'),
 ('pre',  '프리코러스',          'Bメロ'),
 ('cho1', '후렴 · 마법의 양탄자', 'サビ · 魔法の絨毯'),
 ('cho2', '마지막 후렴',         'ラストサビ'),
]
SPEAKERS = [('Singer', '川崎鷹也', '카와사키 타카야', 1), ('', '不明', '화자 미상', 0)]
