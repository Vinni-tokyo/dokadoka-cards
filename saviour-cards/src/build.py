...
OUT = os.path.join(os.path.dirname(S), 'Japanese-Saviour34-Cards.html')
VID = 'NUVdDXGGlVE'

# 구간(빈 줄로 나뉜 덩어리) 순서대로. (키, 한국어, 일본어)
SECTIONS = [
 ('v', '1·2절 · 프리코러스', '1・2番・プリコーラス'),
 ('c1', '후렴', 'サビ'),
 ('v1b', '1절·프리코러스 다시', '1番・プリコーラス'),
 ('c2', '후렴 ×2', 'サビ×2'),
 ('br', '브릿지', 'ブリッジ'),
 ('c3', '마지막 후렴', 'ラストサビ'),
]
SPEAKERS = [('Singer', 'Live Church Worship', 'Live Church Worship', 1), ('', '不明', '화자 미상', 0)]
