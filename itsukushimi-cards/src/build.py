...
OUT = os.path.join(os.path.dirname(S), 'Japanese-Itsukushimi24-Cards.html')
VID = 'dpOpNRUDWgs'

# 구간(빈 줄로 나뉜 덩어리) 순서대로. (키, 한국어, 일본어)
SECTIONS = [
 ('v1', '1절 · 벗 되시는 예수', '1番 · 友なるイエス'),
 ('v2', '2절 · 우리의 약함', '2番 · われらの弱き'),
 ('v3', '3절 · 변치 않는 사랑', '3番 · かわらぬ愛'),
]
SPEAKERS = [('Singer', '4.5Music', '4.5Music', 1), ('', '不明', '화자 미상', 0)]
