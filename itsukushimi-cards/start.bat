...
if not exist "%~dp0Japanese-Itsukushimi24-Cards.html" goto :nofile
set PORT=8114
set PAGE=Japanese-Itsukushimi24-Cards.html
...
:nofile
echo [!] Japanese-Itsukushimi24-Cards.html 을 찾을 수 없습니다.
