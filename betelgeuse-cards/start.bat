...
if not exist "%~dp0Japanese-Betelgeuse52-Cards.html" goto :nofile
set PORT=8103
set PAGE=Japanese-Betelgeuse52-Cards.html
...
:nofile
echo [!] Japanese-Betelgeuse52-Cards.html 을 찾을 수 없습니다.
