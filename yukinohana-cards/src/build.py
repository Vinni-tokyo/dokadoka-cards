...
OUT = os.path.join(os.path.dirname(S), 'Japanese-YukiNoHana46-Cards.html')
VID = 'mF5Qq2YheTg'

# 구간(빈 줄로 나뉜 덩어리) 순서대로. (키, 한국어, 일본어)
SECTIONS = [
 ('v1',     '1절 · 겨울 냄새',            '1番 · 冬の匂い'),
 ('cho1',   '후렴 1 · 올해 첫 눈의 꽃',    'サビ 1 · 今年最初の雪の華'),
 ('v2',     '2절 · 네가 있으면',           '2番 · キミがいると'),
 ('cho2',   '후렴 2 · 흩날리는 눈의 꽃',   'サビ 2 · 舞い落ちてきた雪の華'),
 ('bridge', '브릿지 · 별이 되어',          'Cメロ · 星になって'),
 ('cho3',   '마지막 후렴',                 'ラストサビ'),
 ('outro',  '아웃트로 · 새하얀 눈의 꽃',   'アウトロ · 真っ白な雪の華'),
]
SPEAKERS = [('Singer', '中島美嘉', '나카시마 미카', 1), ('', '不明', '화자 미상', 0)]
