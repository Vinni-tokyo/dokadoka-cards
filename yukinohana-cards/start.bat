...
if not exist "%~dp0Japanese-YukiNoHana46-Cards.html" goto :nofile
set PORT=8105
set PAGE=Japanese-YukiNoHana46-Cards.html
...
:nofile
echo [!] Japanese-YukiNoHana46-Cards.html 을 찾을 수 없습니다.
