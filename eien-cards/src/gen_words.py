...
READING_OVERRIDE = {'離す': 'はなす', '1人': 'ひとり', '行う': 'いく', '抱く': 'だく', '描く': 'かく', '君': 'きみ', '私': 'わたし', '御前': 'おまえ', '御飯': 'ごはん', '御腹': 'おなか', '何': 'なに', '人陰': 'かげ', '瞬間': 'とき', '時々': 'ときどき', '御名': 'みな', '代々': 'よよ', '民': 'たみ'}
...
EXTRA = [('地', '地', 'ち', '땅·곳')]  # 분석기가 「約束の地」의 地를 기호로 본다
missing_meaning = []
lines = []
