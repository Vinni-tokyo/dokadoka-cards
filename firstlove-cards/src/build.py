...
OUT = os.path.join(os.path.dirname(S), 'Japanese-FirstLove28-Cards.html')
VID = 'lLz9_XdyJGo'

# 구간(빈 줄로 나뉜 덩어리) 순서대로. (키, 한국어, 일본어)
SECTIONS = [
 ('v1',   '1절 · 마지막 키스',        '1番 · 最後のキス'),
 ('cho1', '후렴 1 · always gonna be', 'サビ 1'),
 ('v2',   '2절 · 멈춰 선 시간',       '2番 · 立ち止まる時間'),
 ('cho2', '후렴 2 · inside my heart', 'サビ 2'),
 ('cho3', '후렴 3 · 아웃트로',        'サビ 3 · アウトロ'),
]
SPEAKERS = [('Singer', '宇多田ヒカル', '우타다 히카루', 1), ('', '不明', '화자 미상', 0)]
