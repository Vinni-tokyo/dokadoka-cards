...
OUT = os.path.join(os.path.dirname(S), 'Japanese-ForgetMeNot26-Cards.html')
VID = 'djA_CP5DYJQ'

# 구간(빈 줄로 나뉜 덩어리) 순서대로. (키, 한국어, 일본어)
SECTIONS = [
 ('v1', '1절 · 아침 햇살',   '1番 · 小さな朝の光'),
 ('v2', '2절 · 슬픈 꿈',     '2番 · 悲しい夢'),
 ('v3', '3절 · 미쳐버린 거리', '3番 · 狂った街'),
]
SPEAKERS = [('Singer', '尾崎豊', '오자키 유타카', 1), ('', '不明', '화자 미상', 0)]
