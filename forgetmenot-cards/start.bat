...
if not exist "%~dp0Japanese-ForgetMeNot26-Cards.html" goto :nofile
set PORT=8112
set PAGE=Japanese-ForgetMeNot26-Cards.html
...
:nofile
echo [!] Japanese-ForgetMeNot26-Cards.html 을 찾을 수 없습니다.
