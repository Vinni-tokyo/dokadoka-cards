...
VID  = 'LpSDuDIaBGk'
NICK = 'Social'
TITLE_KO = '사회적 건강이 행복과 장수의 열쇠인 이유'
TITLE_EN = 'Why Social Health Is Key to Happiness and Longevity'
SPEAKER  = ('Killam', 'Kasley Killam', '캐슬리 킬럼', 1)

# 장면 = 강연의 논지 전환 (키, 시작초, 한국어, 영어)
SCENES = [
 ('maya',   0,   '도입 · 마야의 이야기',      'Opening: Maya\'s story'),
 ('what',   65,  '사회적 건강이란 무엇인가',   'What social health means'),
 ('why',    195, '왜 중요한가',              'Why it matters'),
 ('how',    265, '5-3-1 지침',              'The 5-3-1 guideline'),
 ('close',  450, '의도적인 관계 · 맺음',      'Being intentional: closing'),
]
