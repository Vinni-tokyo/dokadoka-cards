...
OUT = os.path.join(os.path.dirname(S), 'Japanese-Himawari36-Cards.html')
VID = 'rKsQ-3N-Bks'

# 구간(빈 줄로 나뉜 덩어리) 순서대로. (키, 한국어, 일본어)
SECTIONS = [
 ('v1', '1절 · 왜 네가 우는 거야', '1番 · どうして君が泣くの'),
 ('c1', '후렴 · 곁에 있고 싶어', 'サビ · そばにいたいよ'),
 ('v2', '2절 · 멀리서 켜지는 미래', '2番 · 遠くでともる未来'),
 ('b', '브릿지 · 떠나는 날', 'ブリッジ · 旅立ちの日'),
 ('c2', '후렴 · 돌려주고 싶지만', 'サビ · 返したいけれど'),
 ('c3', '마지막 후렴', 'ラストサビ'),
]
SPEAKERS = [('Singer', '秦基博', '하타 모토히로', 1), ('', '不明', '화자 미상', 0)]
