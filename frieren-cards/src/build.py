...
VIDS = {20: 'DddirskV5Vo', 21: 'dBafvwMBbGk', 22: 'xvGmhEz0WHc'}
TITLES = {20: '心と体が入れ替わる魔法', 21: 'お洗濯の魔法', 22: '考えていることを言ってしまう魔法その2'}
TITLES_KO = {20: '몸과 마음이 바뀌는 마법', 21: '빨래 마법', 22: '생각을 말해버리는 마법 그 두 번째'}
...
if __name__ == '__main__':
    eps = [int(a) for a in sys.argv[1:]] or [20, 21, 22]
    for ep in eps:
        build(ep)
