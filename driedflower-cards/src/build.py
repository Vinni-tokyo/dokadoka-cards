...
OUT = os.path.join(os.path.dirname(S), 'Japanese-DriedFlower49-Cards.html')
VID = 'kzZ6KXDM1RI'

# 구간(빈 줄로 나뉜 덩어리) 순서대로. (키, 한국어, 일본어)
SECTIONS = [
 ('v1',      '1절 · 여유 없던 두 사람',      '1番 · 余裕のない二人'),
 ('cho1',    '후렴 1 · 드라이플라워처럼',     'サビ 1 · ドライフラワーみたい'),
 ('v2',      '2절 · 다행이었어',             '2番 · よかった'),
 ('cho2',    '후렴 2 · 시간이 지나면',        'サビ 2 · 時間が経てば'),
 ('bridge',  '브릿지 · 달빛에',              'Cメロ · 月灯りに'),
 ('bridge2', '브릿지 2 · 가슴 깊은 곳',       'Cメロ 2 · 胸の奥'),
 ('cho3',    '마지막 후렴 · 아직 시들지 않은 꽃', 'ラストサビ · まだ枯れない花'),
]
SPEAKERS = [('Singer', '優里', '유우리', 1), ('', '不明', '화자 미상', 0)]
