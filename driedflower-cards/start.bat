...
if not exist "%~dp0Japanese-DriedFlower49-Cards.html" goto :nofile
set PORT=8107
set PAGE=Japanese-DriedFlower49-Cards.html
...
:nofile
echo [!] Japanese-DriedFlower49-Cards.html 을 찾을 수 없습니다.
