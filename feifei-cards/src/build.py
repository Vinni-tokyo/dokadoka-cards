...
VID = 'ITxsc3mgqts'
NICK = 'FeiFei'      # 출력 파일명 English-<NICK><카드수>-Cards.html

# 장면 = 다큐의 화제 전환 시각 (공식 챕터 없음)
# (키, 시작초, 한국어, 영어)
SCENES = [
 ('walk',       0,    '산책 인터뷰 · 소개',             'Walk and talk & intro'),
 ('kid',        98,   '어린 시절 · 이민',               'Childhood & emigration'),
 ('imagenet',   202,  '초기 AI 연구 · ImageNet',        'Early AI research & ImageNet'),
 ('godmother',  322,  '「AI 의 대모」 라는 호칭',        'The Godmother title'),
 ('startup',    411,  '창업 · World Labs',              'Founding World Labs'),
 ('worldmodel', 464,  '월드 모델이란',                   'What is a world model'),
 ('marble',     575,  'Marble 시연 · 데이터·비결',        'Marble demo, data & the secret'),
 ('stage',      701,  '무대 대담 · 로봇 · 경쟁',         'On stage: robots & competition'),
 ('early',      865,  '아직 이른 분야 · 회의론',          'Early days & skeptics'),
 ('society',    957,  '학생 · 미국 · 정책',              'Students, the US & policy'),
 ('risks',      1187, '위험 · 신 콤플렉스 · 거버넌스',     'Risks, god complexes & governance'),
 ('future',     1322, '미래 · 낙관 · UFO',              'The future, optimism & UFOs'),
]
# 화자 = turns.txt 로 손으로 지정한 화자. '' 은 화자 미상
SPEAKERS = [
 ('Li',        'Fei-Fei Li (World Labs)',       '페이페이 리 (World Labs)',   1),
 ('Emily',     'Emily Chang (host)',            '에밀리 창 (진행자)',        1),
 ('Narration', 'Narration (Emily Chang)',       '내레이션',                 0),
 ('Justin',    'Justin Johnson (co-founder)',   '저스틴 존슨 (공동창업자)',    0),
 ('Announcer', 'Stage announcer',               '무대 안내',                0),
 ('Schmidt',   'Eric Schmidt (clip)',           '에릭 슈밋 (자료 영상)',      0),
 ('Crowd',     'Students (clip)',               '학생들 (자료 영상)',        0),
 ('',          'Unknown',                       '화자 미상',               0),
]
ko = {}
