...
VID  = 'Vl6VhCAeEfQ'
NICK = 'Tipping'
TITLE_KO = '기후변화의 티핑포인트, 지금 어디쯤인가'
TITLE_EN = 'The Tipping Points of Climate Change — and Where We Stand'
SPEAKER  = ('Rockstrom', 'Johan Rockström', '요한 록스트룀', 1)

# 장면 = 강연의 논지 전환 (키, 시작초, 한국어, 영어)
SCENES = [
 ('nervous', 0,    '과학자들이 불안한 이유',    'Why scientists are nervous'),
 ('limits',  120,  '지구 위험 한계선',          'Planetary boundaries'),
 ('heat',    380,  '바다가 흡수한 열',          'The heat the ocean absorbs'),
 ('assess',  560,  '티핑포인트를 재다',         'Assessing the tipping points'),
 ('where',   700,  '지금 우리는 어디에',        'Where we stand now'),
 ('solve',   960,  '해법 · 지금 할 일',        'Solutions: what to do now'),
]
