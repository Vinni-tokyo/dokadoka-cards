#!/usr/bin/env python3
"""milky-cards 전용 학습 음원 생성기 (7화 각각 src/epN/audio/ 에 저장).
   사용: ../../.venv/bin/python make_audio.py [ep번호 ...]   (생략하면 전체)
   먼저 build.py 를 돌려 Japanese-MilkyN-Cards.html 이 있어야 한다."""
...
def study_of(ep):
    path = os.path.join(ROOT, f'Japanese-Milky{ep}-Cards.html')
...
if __name__ == '__main__':
    ...
    eps = [int(a) for a in args] or list(range(1, 8))
    for ep in eps:
